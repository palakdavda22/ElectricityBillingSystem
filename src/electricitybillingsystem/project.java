...
public class project extends JFrame implements ActionListener{
    project(){
        ...
        Image i3 = ic.getImage().getScaledInstance(1900, 900, Image.SCALE_DEFAULT);
        ...
        ut3.setIcon(new ImageIcon(image9));
        ut3.setMnemonic('C');
        ut3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
        ...
        ex.setIcon(new ImageIcon(image9));
        ex.setMnemonic('C');
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            System.exit(0);
        }else if(msg.equals("Generater Bill")){
